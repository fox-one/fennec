...
export default class WalletState {
  ...
  #rawTransactionsRequests: Record<string, RawTransactionRequestWithResolver> =
    {};
  ...
  public readonly transferRequestsSubject: BehaviorSubject<any> =
    new BehaviorSubject([]);

  public readonly multisigsTransactionsSubject: BehaviorSubject<any> =
    new BehaviorSubject([]);
