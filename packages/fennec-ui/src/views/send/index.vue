      ...
      <template v-if="asset">
        <v-layout class="f-caption mt-5" align-center>
          ...
          <v-btn text small color="primary" @click="handleToggleMethod">
            <span v-if="!useAddress" class="f-caption">tranfer to address</span>
            <span v-else class="f-caption">transfer to contact</span>
          </v-btn>
        </v-layout>
...
<script lang="ts">
import { Address, Asset, User } from "@foxone/mixin-api/types";
